...
If you need to point the gateway at a different Kind 2 binary, set KIND2_KIND2_PATH before starting src/web/kind2-gateway.cjs.
...
Set `KIND2_SAFE_MODE=1` and point the server to the Kind 2 binary with `KIND2_KIND2_PATH`.
